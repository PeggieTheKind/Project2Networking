...
// source: RyansProtocol.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_RyansProtocol_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_RyansProtocol_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_RyansProtocol_2eproto
...
struct TableStruct_RyansProtocol_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RyansProtocol_2eproto;
namespace tutorial {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tutorial::AuthenticateWeb* Arena::CreateMaybeMessage<::tutorial::AuthenticateWeb>(Arena*);
template<> ::tutorial::AuthenticateWebFailure* Arena::CreateMaybeMessage<::tutorial::AuthenticateWebFailure>(Arena*);
template<> ::tutorial::AuthenticateWebSuccess* Arena::CreateMaybeMessage<::tutorial::AuthenticateWebSuccess>(Arena*);
template<> ::tutorial::CreateAccountWeb* Arena::CreateMaybeMessage<::tutorial::CreateAccountWeb>(Arena*);
template<> ::tutorial::CreateAccountWebFailure* Arena::CreateMaybeMessage<::tutorial::CreateAccountWebFailure>(Arena*);
template<> ::tutorial::CreateAccountWebSuccess* Arena::CreateMaybeMessage<::tutorial::CreateAccountWebSuccess>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tutorial {
...
class CreateAccountWeb final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.CreateAccountWeb) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.CreateAccountWeb";
  }
  protected:
  ...
  // required int64 requiredId = 1;
  bool has_requiredid() const;
  private:
  bool _internal_has_requiredid() const;
  public:
  void clear_requiredid();
  ::PROTOBUF_NAMESPACE_ID::int64 requiredid() const;
  void set_requiredid(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_requiredid() const;
  void _internal_set_requiredid(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:

  // @@protoc_insertion_point(class_scope:tutorial.CreateAccountWeb)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 requiredid_;
  friend struct ::TableStruct_RyansProtocol_2eproto;
};
// -------------------------------------------------------------------

class CreateAccountWebSuccess final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.CreateAccountWebSuccess) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.CreateAccountWebSuccess";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:tutorial.CreateAccountWebSuccess)
 private:
  class _Internal;
...
class CreateAccountWebFailure final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.CreateAccountWebFailure) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.CreateAccountWebFailure";
  }
  protected:
...
class AuthenticateWeb final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.AuthenticateWeb) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.AuthenticateWeb";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:tutorial.AuthenticateWeb)
 private:
  class _Internal;
...
class AuthenticateWebSuccess final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.AuthenticateWebSuccess) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.AuthenticateWebSuccess";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:tutorial.AuthenticateWebSuccess)
 private:
  class _Internal;
...
class AuthenticateWebFailure final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.AuthenticateWebFailure) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tutorial.AuthenticateWebFailure";
  }
  protected:
...
// required int64 requiredId = 1;
inline bool CreateAccountWeb::_internal_has_requiredid() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CreateAccountWeb::has_requiredid() const {
  return _internal_has_requiredid();
}
inline void CreateAccountWeb::clear_requiredid() {
  requiredid_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CreateAccountWeb::_internal_requiredid() const {
  return requiredid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CreateAccountWeb::requiredid() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWeb.requiredId)
  return _internal_requiredid();
}
inline void CreateAccountWeb::_internal_set_requiredid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000004u;
  requiredid_ = value;
}
inline void CreateAccountWeb::set_requiredid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_requiredid(value);
  // @@protoc_insertion_point(field_set:tutorial.CreateAccountWeb.requiredId)
}
...
inline const std::string& CreateAccountWeb::email() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWeb.email)
...
void CreateAccountWeb::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.CreateAccountWeb.email)
}
inline std::string* CreateAccountWeb::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:tutorial.CreateAccountWeb.email)
  return _s;
}
...
inline std::string* CreateAccountWeb::release_email() {
  // @@protoc_insertion_point(field_release:tutorial.CreateAccountWeb.email)
...
inline void CreateAccountWeb::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tutorial.CreateAccountWeb.email)
}
...
inline const std::string& CreateAccountWeb::plaintextpassword() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWeb.plainTextPassword)
...
void CreateAccountWeb::set_plaintextpassword(ArgT0&& arg0, ArgT... args) {
 ...
 plaintextpassword_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.CreateAccountWeb.plainTextPassword)
}
inline std::string* CreateAccountWeb::mutable_plaintextpassword() {
  std::string* _s = _internal_mutable_plaintextpassword();
  // @@protoc_insertion_point(field_mutable:tutorial.CreateAccountWeb.plainTextPassword)
  return _s;
}
...
inline std::string* CreateAccountWeb::release_plaintextpassword() {
  // @@protoc_insertion_point(field_release:tutorial.CreateAccountWeb.plainTextPassword)
...
inline void CreateAccountWeb::set_allocated_plaintextpassword(std::string* plaintextpassword) {
  ...
  plaintextpassword_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), plaintextpassword,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:tutorial.CreateAccountWeb.plainTextPassword)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CreateAccountWebSuccess::requestid() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWebSuccess.requestId)
...
inline void CreateAccountWebSuccess::set_requestid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:tutorial.CreateAccountWebSuccess.requestId)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CreateAccountWebSuccess::userid() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWebSuccess.userId)
...
inline void CreateAccountWebSuccess::set_userid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:tutorial.CreateAccountWebSuccess.userId)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CreateAccountWebFailure::requestid() const {
  // @@protoc_insertion_point(field_get:tutorial.CreateAccountWebFailure.requestId)
  return _internal_requestid();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AuthenticateWeb::requestid() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWeb.requestId)
  return _internal_requestid();
}
...
inline void AuthenticateWeb::set_requestid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWeb.requestId)
}
...
inline const std::string& AuthenticateWeb::email() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWeb.email)
  return _internal_email();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AuthenticateWeb::set_email(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWeb.email)
}
inline std::string* AuthenticateWeb::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:tutorial.AuthenticateWeb.email)
  return _s;
}
...
inline std::string* AuthenticateWeb::release_email() {
  // @@protoc_insertion_point(field_release:tutorial.AuthenticateWeb.email)
  if (!_internal_has_email()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void AuthenticateWeb::set_allocated_email(std::string* email) {
  ...
  email_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), email,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:tutorial.AuthenticateWeb.email)
}
...
inline const std::string& AuthenticateWeb::plaintextpassword() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWeb.plaintextPassword)
  return _internal_plaintextpassword();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AuthenticateWeb::set_plaintextpassword(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 plaintextpassword_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWeb.plaintextPassword)
}
inline std::string* AuthenticateWeb::mutable_plaintextpassword() {
  std::string* _s = _internal_mutable_plaintextpassword();
  // @@protoc_insertion_point(field_mutable:tutorial.AuthenticateWeb.plaintextPassword)
  return _s;
}
...
inline std::string* AuthenticateWeb::release_plaintextpassword() {
  // @@protoc_insertion_point(field_release:tutorial.AuthenticateWeb.plaintextPassword)
  if (!_internal_has_plaintextpassword()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000002u;
...
inline void AuthenticateWeb::set_allocated_plaintextpassword(std::string* plaintextpassword) {
  ...
  plaintextpassword_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), plaintextpassword,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:tutorial.AuthenticateWeb.plaintextPassword)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AuthenticateWebSuccess::requestid() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWebSuccess.requestId)
  return _internal_requestid();
}
...
inline void AuthenticateWebSuccess::set_requestid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWebSuccess.requestId)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AuthenticateWebSuccess::userid() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWebSuccess.userId)
  return _internal_userid();
}
...
inline void AuthenticateWebSuccess::set_userid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWebSuccess.userId)
}
...
inline const std::string& AuthenticateWebSuccess::creationdate() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWebSuccess.creationDate)
...
void AuthenticateWebSuccess::set_creationdate(ArgT0&& arg0, ArgT... args) {
 ...
 creationdate_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tutorial.AuthenticateWebSuccess.creationDate)
}
inline std::string* AuthenticateWebSuccess::mutable_creationdate() {
  std::string* _s = _internal_mutable_creationdate();
  // @@protoc_insertion_point(field_mutable:tutorial.AuthenticateWebSuccess.creationDate)
  return _s;
}
...
inline std::string* AuthenticateWebSuccess::release_creationdate() {
  // @@protoc_insertion_point(field_release:tutorial.AuthenticateWebSuccess.creationDate)
...
inline void AuthenticateWebSuccess::set_allocated_creationdate(std::string* creationdate) {
  ...
  creationdate_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), creationdate,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:tutorial.AuthenticateWebSuccess.creationDate)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AuthenticateWebFailure::requestid() const {
  // @@protoc_insertion_point(field_get:tutorial.AuthenticateWebFailure.requestId)
  return _internal_requestid();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_RyansProtocol_2eproto
